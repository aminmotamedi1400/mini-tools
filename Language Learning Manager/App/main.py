...
from utils import COLORS, FONTS, create_rounded_button

# Import page modules
from dashboard import DashboardPage
from vocabulary import VocabularyPage
from sessions import SessionsPage
from grammar import GrammarPage
from errors_log import ErrorsPage
...
class LanguageLearningManager:
    ...
    def show_page(self, page_name):
        ...
        if page_name == "dashboard":
            ...
            from sentences import SentencesPage
